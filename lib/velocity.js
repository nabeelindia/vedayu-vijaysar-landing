 ...
 * Endpoint: /forward-order-orchestration
 * Creates the order, auto-assigns courier, and generates AWB in one call.
 *
 * @param {object} order
 ...
 * @returns {{ awb, shipmentId, courierName, labelUrl, velocityOrderId }}
 */
export async function createOrder(order) {
  ...
  const payload = {
    ...
    order_date:            now,
    carrier_id:            '',          // blank = auto-assign via Velocity shipping rules
